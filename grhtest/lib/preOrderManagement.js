define(function( require, exports, module ){
	...
	pub.preOrderManagement.apiHandle = {
		...
		order_del : {
			init : function(){
				common.ajaxPost({
					method : pub.preOrderManagement.orderCode ? 'pre_order_del' : 'order_del',
	...
	pub.preOrderDetail.paramListInit = function(){
		...
		pub.preOrderDetail.TIP_MESSAGE = { 
			...
			'deleteBtn' : { text : '确定删除订单？', apiMethod : pub.preOrderDetail.method }
		};
		...
		order_details : {
			...
			apiData : function( d ){
		    	...
		    	(function(){
		    		...
		    		if(d.payStatus == '1' && d.preGoods.preStatus == "exprice"){
		...
		unite_deal : {
			init : function(){
				common.ajaxPost({
					...
					d.statusCode == '100000' && common.jumpLinkPlainApp( pub.preOrderDetail.URL_RELATED[ pub.preOrderDetail.API_METHOD ] );

					...
					$(".redpick_center_top").on("click",".redPick_btn1",function(e){
						...
						if (l) {
							common.jsInteractiveApp({
								name:'jumpLinkCustom',
								parameter:pub.logined ? (function(){
									var ll = window.location.href.substring(0, window.location.href.indexOf("/html/"));
										imgIcon =  ll + '/img/icon_Invalid.png';
									return {
										title:"优惠卷管理",
										url:"html/couponList.html",
